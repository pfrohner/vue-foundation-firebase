...
Abide.defaults.patterns['number_positive'] = /^[+]?\d*(?:[\.\,]\d+)?$/; // eslint-disable-line
Reveal.defaults.appendTo = '.off-canvas-content';
Reveal.defaults.animationIn = 'scale-in-up';
Reveal.defaults.animationOut = 'scale-out-down';
Reveal.defaults.deepLink = true;
Reveal.defaults.updateHistory = true;
